    ...
    return (
        <StockCardStyled>
            ...
            <BottomPanelStyled>
                ...
                <ResultStyled color={stockData.current_change < 0 ? `${PRICE_DOWN}`:`${PRICE_UP}`}>{stockData.current_change >= 0 &&'+'}{stockData.current_change % 1 !== 0 ? stockData.current_change.toFixed(2) : stockData.current_change}%</ResultStyled>
                </Column>
            </BottomPanelStyled>
            <PeriodsStlyed>
            ...
            <PeriodsStlyed time>
                ...
                <PeriodStyled>11:00</PeriodStyled>
